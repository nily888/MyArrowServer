...
--
-- Table structure for table `runden`
--
...
CREATE TABLE `runden` (
  ...
  `startzeit` bigint(20) DEFAULT NULL,
  `s_startzeit` varchar(45) DEFAULT NULL,
  `endzeit` bigint(20) DEFAULT NULL,
  `wetter` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`_id`,`gid`),
