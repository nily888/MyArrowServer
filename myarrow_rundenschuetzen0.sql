...
--
-- Dumping data for table `rundenschuetzen`
--

LOCK TABLES `rundenschuetzen` WRITE;
/*!40000 ALTER TABLE `rundenschuetzen` DISABLE KEYS */;
/*!40000 ALTER TABLE `rundenschuetzen` ENABLE KEYS */;
UNLOCK TABLES;
